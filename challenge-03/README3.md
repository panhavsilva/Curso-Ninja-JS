...
*/
pessoa.nomeCompleto(); //Olá! Meu nome é Pamela Vieira!
...
inline ao lado da instrução para mostrar qual foi a resposta retornada)
*/
pessoa.mostrarAltura(); // Minha altura é 1.63 m.
...
pessoa.apresentacao = function () {
  var artigo = 'o ';
  singular_plural = ' anos, '; 
  plural_singular = ' metros!';
...
// Agora, apresente-se ;)
pessoa.apresentacao();
/*Olá, eu sou a Pamela Vieira, tenho 34 anos, 1.63, meu peso é 60 Kg e, só hoje, 
eu já caminhei 15 metros! */
```
