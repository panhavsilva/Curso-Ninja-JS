...
desafio.
*/
var teams = ['Avaí', 'Chapecoense', 'Figueirense', 'Criciúma', 'Joinville'];
...
showTeamPosition(1); // O time que está em 1º é o Avaí.
showTeamPosition(2); // O time que está em 2º é o Chapecoense.
showTeamPosition(6); // Não temos a informação do time que está nessa posição.
showTeamPosition(4); // O time que está em 4º é o Criciúma.
...
convertToHex('verde') //Não temos o equivalente hexadecimal para amarelo.
