(function(){
  ...
  */
  ...
  var sevenLetters = brasil.every(
    function(item, index){
      return item.length > 7;
    }
  );

  console.log(sevenLetters === true ?
    'Sim, todos os estados tem mais de 7 letras!' :
    'Nem todos os estados tem mais de 7 letras!'
  );

  /*
  Percorra o array `brasil` e verifique se o Ceará está incluído, atribuindo o resultado à uma variável. Se esse estado existir no array, mostrar a frase no
  console:
  - "Ceará está incluído!"
  ...
  */
  ...
  var isCeara = brasil.some(
    function(item){
     return item === 'Ceará';
    }
  );

  console.log(isCeara === true ?
    'Ceará está incluído!' :
    'Ceará não foi incluído :('
  );
  /*
