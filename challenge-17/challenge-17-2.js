(function(){
  ...
  */
  ...
  text = text.replace( /Manuel Marques de Sousa/g,'Pamela Vieira da Silva' );
  ...
  */
  ...
  text = text.replace( /brasileiro/g,'florianópolitana' );
  ...
  */
  ...
  text = text.replace( /O Centauro de Luvas/g, function(captura){
  ...
  */
  ...
  function replaceDate(capturaTutal,dia,mes,ano){
