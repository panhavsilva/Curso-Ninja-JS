(function(){
  ...
  */
  ...
  console.log(cpfs[0] = cleanCPF('049-214 3421-1') );
  console.log(cpfs[1] = cleanCPF('210.458.522-05') );
  console.log(cpfs[2] = cleanCPF('735 500 794 - 22') );
  console.log(cpfs[3] = cleanCPF('101.123-131x32') );
  ...
  */
  ...
  console.log(cpfs[0].replace(regexCpf,'$1.$2.$3-$4'));
  console.log(cpfs[1].replace(regexCpf,'$1.$2.$3-$4'));
  console.log(cpfs[2].replace(regexCpf,'$1.$2.$3-$4'));
  console.log(cpfs[3].replace(regexCpf,'$1.$2.$3-$4'));
  /*
  ...
  */
  ...
  console.log(frase3.match(/<\w+><\/\w+>/g));
  ...
  */
  ...
  frase4 =  frase4.replace( /(><)/g, '>\n<');
  var regexFrase4 = /<(\w+)>(.+)(<\/\w+>)/g;

  function regexFrase(capTotal,cap1,frasecap,cap2){
    return '<' + cap1 + '> O texto dentro da tag ' + cap1 +
    ' é ' + frasecap + cap2;
  }
  console.log(frase4.replace(regexFrase4,regexFrase));
})();
